...
func (x *PlayMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlayMessage) ProtoMessage() {}

func (x *PlayMessage) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_service_proto_msgTypes[0]
...
// Deprecated: Use PlayMessage.ProtoReflect.Descriptor instead.
func (*PlayMessage) Descriptor() ([]byte, []int) {
	return file_api_proto_service_proto_rawDescGZIP(), []int{0}
}

func (x *PlayMessage) GetSongName() string {
	if x != nil {
		return x.SongName
	}
	return ""
...
var file_api_proto_service_proto_rawDesc = []byte{
	...
	0x22, 0x29, 0x0a, 0x0b, 0x50, 0x6c, 0x61, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	0x1a, 0x0a, 0x08, 0x53, 0x6f, 0x6e, 0x67, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x53, 0x6f, 0x6e, 0x67, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x07, 0x0a, 0x05, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x32, 0x36, 0x0a, 0x08, 0x50, 0x6c, 0x61, 0x79, 0x6c, 0x69, 0x73, 0x74,
	0x12, 0x2a, 0x0a, 0x04, 0x50, 0x6c, 0x61, 0x79, 0x12, 0x0c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x12, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x50,
	0x6c, 0x61, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08,
...
var file_api_proto_service_proto_goTypes = []interface{}{
	(*PlayMessage)(nil), // 0: proto.PlayMessage
	(*Empty)(nil),       // 1: proto.Empty
}
var file_api_proto_service_proto_depIdxs = []int32{
	1, // 0: proto.Playlist.Play:input_type -> proto.Empty
	0, // 1: proto.Playlist.Play:output_type -> proto.PlayMessage
